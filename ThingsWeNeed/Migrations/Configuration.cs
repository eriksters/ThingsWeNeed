namespace ThingsWeNeed.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ThingsWeNeed.DAL.TwnContext>
    {
        ...
        protected override void Seed(ThingsWeNeed.DAL.TwnContext context)
        {
